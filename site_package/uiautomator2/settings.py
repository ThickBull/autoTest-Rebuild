...
class Settings(object):
    ...
    def __init__(self, d):
        ...
        self._defaults = {
            ...
            "xpath_debug": False,
            "operation_delay": (0, 0),
            "operation_delay_methods": ["click", "swipe", "drag", "drag_to", "press"],
